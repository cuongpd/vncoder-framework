...
function updateChoicesOptions(selector, optionsArray) {
	...
	if (!el) return;
	const choices = el.choicesInstance;
	if (!choices) return;
	choices.clearStore();
	choices.clearChoices();
	choices.clearInput();
	choices.removeActiveItems();
	choices.setChoices(optionsArray, 'value', 'label', true);
}

document.querySelectorAll('select.js-choices').forEach(function (el) {
