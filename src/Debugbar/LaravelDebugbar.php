...
use VnCoder\Debugbar\DataCollector\CacheCollector;
use VnCoder\Debugbar\DataCollector\EventCollector;
use VnCoder\Debugbar\DataCollector\FilesCollector;
use VnCoder\Debugbar\DataCollector\GateCollector;
use VnCoder\Debugbar\DataCollector\LaravelCollector;
use VnCoder\Debugbar\DataCollector\LogsCollector;
use VnCoder\Debugbar\DataCollector\MultiAuthCollector;
use VnCoder\Debugbar\DataCollector\QueryCollector;
use VnCoder\Debugbar\DataCollector\SessionCollector;
use VnCoder\Debugbar\DataCollector\RequestCollector;
use VnCoder\Debugbar\DataCollector\RouteCollector;
use VnCoder\Debugbar\DataCollector\ViewCollector;
use VnCoder\Debugbar\DataFormatter\QueryFormatter;
use VnCoder\Debugbar\Storage\SocketStorage;
use VnCoder\Debugbar\Storage\FilesystemStorage;
use VnCoder\Debugbar\Support\Clockwork\ClockworkCollector;
    ...
    public function boot()
    {
        ...
        if ($this->shouldCollect('db', true) && isset($app['db']) && $events) {
            ...
            if ($dbBacktrace = $config->get('debugbar.options.db.backtrace')) {
                $queryCollector->setFindSource($dbBacktrace, []);
            }
