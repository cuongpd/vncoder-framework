...
class Decoder
{
    ...
    private function decodeByType($type, $offset, $size)
    {
        ...
        switch ($type) {
            ...
            default:
                throw new Exception('Unknown or unexpected type: ' . $type);
        }
    }
    ...
    {
        if ($expected !== $actual) {
            throw new Exception("The MaxMind DB file's data section contains bad data (unknown data type or corrupt data)");
        }
    }
    ...
    private array $pointerValueOffset = [
        1 => 0,
        2 => 2048,
        3 => 526336,
        4 => 0,
