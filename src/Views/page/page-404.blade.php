...
<head>
    ...
    <style>
        ...
        .error-container > span.zero:after{content:'';display:block;position:absolute;border-radius:999px;width:70px;height:70px;left:43px;bottom:43px;background:#222529;box-shadow:-2px 2px 2px 0 rgba(0,0,0,0.1)}
        ...
        *{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}
        ...
        html,button,input,select,textarea{font-family:'Montserrat',Helvetica,sans-serif;color:#bbb}
        h1{text-align:center;margin:30px 15px}
        .zoom-area{max-width:80%;margin:30px auto;font-size:20px;text-align:center}
        .link-container{text-align:center}
        a.more-link{text-transform:uppercase;font-size:13px;background-color:#de7e85;padding:10px 15px;border-radius:10;color:#fff;display:inline-block;margin-right:5px;margin-bottom:5px;line-height:1.5;text-decoration:none;margin-top:50px;letter-spacing:1px}
    </style>

    <script>
        let countdown = 10;
        function updateCountdown() {
            document.getElementById('countdown').innerText = countdown > 10 ? countdown : '0' + countdown;
        }
...
<body style="background-color:#222529;">
    <h1>404 - Not Found</h1>
    <p class="zoom-area"><strong>Sorry, the page you are looking for might be in another castle.</strong></p>
    ...
    <div class="link-container">
        <p>Redirecting to <a href="{{BASE_URL}}" class="more-link">home</a> in <span id="countdown">10</span> seconds...</p>
    </div>
